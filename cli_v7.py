...
from core.runtime_kernel_types import RuntimeEvent, RuntimeRequest, TurnStatus
...
async def async_main() -> int:
    ...
    parser.add_argument("--history-file", default="./logs/cli_v6_3_history.txt", help="Readline history file")
    parser.add_argument(
        "--rehydrate-history",
        type=int,
        default=100,
    ...
    def _runtime_event_to_ui(event: RuntimeEvent) -> None:
        ...
        if event.type == "phase_changed":
            detail = f"[PHASE] {event.phase.value if event.phase else '-'}"
    ...
    loop = V7(
        ...
        memory_artifact_dir=effective_memory_artifact_dir,
        memory_user_id=cfg.memory_user_id,
        workspace_path=workspace_path,
        memory_api_key=cfg.api_key,
        memory_api_key_env=cfg.api_key_env,
        memory_model_name=cfg.model_name,
        memory_base_url=cfg.base_url,
        memory_backend_config=cfg.memory_backend_config or {},
    )
