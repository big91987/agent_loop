...
- 总览（大白话 + 系统扫描 + benchmark）：`/Users/admin/work/agent_loop/docs/memory/memory_research_overview.md`
- 术语对照（item/type/category 等）：`/Users/admin/work/agent_loop/docs/memory/memory_terms_compare.md`
...
- 多产品系统化扫描（Round 1）：`/Users/admin/work/agent_loop/docs/memory/memory_products_systematic_scan_round1.md`
- 多产品独立报告（按你指定顺序）：
  - `01 Mem0`：`/Users/admin/work/agent_loop/docs/memory/products/01_mem0.md`（已测试）
  - `02 OpenClaw Memory`：`/Users/admin/work/agent_loop/docs/memory/products/02_openclaw_memory.md`（已测试）
  - `03 Claude-mem`：`/Users/admin/work/agent_loop/docs/memory/products/03_claude_mem.md`（已测试）
  - `04 SimpleMem`：`/Users/admin/work/agent_loop/docs/memory/products/04_simplemem.md`（已测试）
  - `05 EverMemOS`：`/Users/admin/work/agent_loop/docs/memory/products/05_evermemos.md`（暂不测试）
